...
SOURCE="https://sourceforge.net/projects/openofficeorg.mirror/files/4.1.14/binaries/en-US/Apache_OpenOffice_4.1.14_Linux_x86_install-deb_en-US.tar.gz/download/download"
...
all:
	...
	export ARCH=x86 && bin/appimagetool-i686.AppImage AppDir $(OUTPUT)
